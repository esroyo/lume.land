...
Some source files can
[generate multiple pages](../docs/core/04.multiple-pages.md). You can include a
query after the file name to select the specific page generated by the source
file. For example:
