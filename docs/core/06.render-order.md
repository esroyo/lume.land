...
In Lume, all pages are rendered concurrently. This works well in most cases, but
sometimes you want to make sure a page is rendered before or after others. The
most typical example is with auto-generated pages. Let's say you have a page
...
To list and paginate all these auto-generated pages, you can use something like
this:
...
don't exist yet when we are paginating them, so the pagination won't work. What
we really need is create all dynamic pages **before** the pagination.
